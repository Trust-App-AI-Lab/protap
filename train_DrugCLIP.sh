data_path='../DrugCLIP/data/train_no_test_af'
...
CUDA_VISIBLE_DEVICES="1,2,3,4,5,6,7" python train_DrugCLIP.py --master_port $MASTER_PORT $(which unicore-train) --data $data_path --user-dir ./prot_learn/models/drugclip/unimol --train-subset train --valid-subset valid \
