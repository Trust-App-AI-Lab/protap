...
class ProteinGraphDataset(data.Dataset):
    ...
    '''
    def __init__(self, data_list,family_label=False,
    ...
    def __getitem__(self, i): return self._featurize_as_graph(self.data_list[i],self.family_label)

    def _featurize_as_graph(self, protein,family_label=False):
        name = protein['name']
        with torch.no_grad():
        ...
        if family_label ==True:
            Pfam = protein['Pfam']
            data = torch_geometric.data.Data(x=X_ca, seq=seq, name=name,family=Pfam,
