...
from trainers.trainers import EgnnGOTrainer, DataCollatorForEgnnGO
...
if __name__ == '__main__':
    ...
    trainer = EgnnGOTrainer(
        model=model,
        train_dataset=dataset,
        args=training_args,
        data_collator=DataCollatorForEgnnGO(),
    )
    ...
    test_loader = DataLoader(
        ...
        batch_size=96,
        shuffle=True,
        collate_fn=DataCollatorForEgnnGO(),
        # num_workers=4
    )
